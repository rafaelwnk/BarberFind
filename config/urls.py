...
from core.views import account_view, appointments_view, barber_services_view, cancel_appointment_view, confirm_appointment_view, delete_barber_view, delete_service_view, edit_barber_view, edit_service_view, home_view, index_view, reports_view, search_view, dashboard_view, barbers_view, create_barber_view, services_view, create_service_view
